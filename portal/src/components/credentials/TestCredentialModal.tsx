...
export function TestCredentialModal({
  ...
  return (
    <div
      ...
      aria-modal="true"
    >
      <div className="bg-white rounded-4xl w-full max-w-md shadow-2xl">
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full ps-10 pe-4 py-3 border border-gray-100 rounded-2xl text-sm font-mono focus:ring-2 focus:ring-blue-500 outline-none transition-all placeholder:text-gray-300"
                placeholder="Enter push token..."
              />
              <Smartphone className="absolute start-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-300" />
            </div>
        ...
        <div className="p-8 bg-gray-50 border-t flex justify-end gap-3 rounded-b-4xl">
