...
import { createAppSchema, appResponseSchema, appListResponseSchema, updateAppSchema, webhookConfigResponseSchema, killAppResponseSchema, testWebhookResponseSchema } from '../schemas/apps';
import { registerUserSchema, registerDeviceSchema, userResponseSchema, userListResponseSchema, deviceResponseSchema, deviceListResponseSchema } from '../schemas/users';
import { createNotificationSchema, sendEventSchema, notificationResponseSchema, sendEventResponseSchema, testNotificationResponseSchema } from '../schemas/notifications';
import { createTemplateSchema, updateTemplateSchema, templateResponseSchema, templateListResponseSchema } from '../schemas/templates';
import { createABTestSchema, updateABTestSchema, abTestResponseSchema, abTestListResponseSchema, abTestResultsResponseSchema } from '../schemas/abtests';
import { createCampaignSchema, updateCampaignSchema, campaignResponseSchema, campaignListResponseSchema, campaignStatsResponseSchema, audienceEstimateResponseSchema, detailedAudienceEstimateResponseSchema } from '../schemas/campaigns';
import { loginSchema, registerSchema, loginResponseSchema, meResponseSchema, adminUserResponseSchema, adminUserListResponseSchema, assignmentResponseSchema, changePasswordSchema } from '../schemas/admin';
import { createOrgSchema, createRoleSchema, updateRoleSchema, addMemberSchema, updateMemberSchema, orgResponseSchema, orgListResponseSchema, roleResponseSchema, roleListResponseSchema, memberResponseSchema, permissionListResponseSchema } from '../schemas/orgs';
...
pathRegistry.registerPath({
    ...
    request: {
        ...
        body: {
            content: {
                'application/json': {
                    schema: sendEventSchema.omit({ eventName: true }),
                },
            },
        },
    },
...
pathRegistry.registerPath({
    ...
    tags: ['Campaigns'],
    request: {
        query: z.object({ appId: z.string().uuid().optional(), status: z.string().optional() }),
    },
    responses: {
        200: {
